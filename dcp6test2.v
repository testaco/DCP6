//
//							dcp6test2.v - Test DCP-6 PCB with 2 Tuners
//
...
//
//	Test configuration for DCP-6 and DCP-6A supporting 2 independently tunable channels.
// Memory-mapped I/O with regular LS ADC/DAC port (no test mux.)
//
// ISE 14.6 balanced design goal w/o resamplers or quad FIR filter:
// 11130 LUT6s (74%), 11064 registers (36%), 51 RAM and 25 DSP48 synthesized in XC6SLX25-2.
// 9670 LUT6s (64%) and 10998 registers (36%) implemented with 3362 (89%) slices occupied.
// Compile time appx. 23 min.
//
// ISE 14.6 balanced design goal w/o resamplers:
// 11945 LUT6s (79%), 11168 registers (37%), 51 RAM and 29 DSP48 synthesized in XC6SLX25-2.
// 10370 LUT6s (68%) and 11101 registers (36%) implemented with 3470 (92%) slices occupied.
// Compile time appx. 24 min.
//
// History:
...
//		2013-11-16	remove quad FIR filter
//
module dcp6test2 (
...
// Memory-mapped input multiplxer supports 16 blocks of 1024 ports
MUX16X16 miomux (
	.D0(mio0),				// modem 1
	.D1(mio1),				// FFT 1
	.D2(mio2),				// Tuner 1
	...
	.D14(16'hFFFF),
	.D15(16'hFFFF),
	.S(mdosel[13:10]),	// upper bits of I/O address
...
assign miocs8 = (msel[15:10] == 6'b111000);	// VD 1
assign miocs9 = (msel[15:10] == 6'b111001);	// VD 2
...
//assign iocs3 = (ioaddr[6:3] == 3);		// unused
